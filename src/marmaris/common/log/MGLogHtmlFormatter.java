...
/**
 * My custom html formatter for my Logger
 */
class MGLogHtmlFormatter extends Formatter {
    ...
    private String calcDate(long millisecs) {
        SimpleDateFormat date_format = new SimpleDateFormat(MGAppShared.DATE_TIME_ZONE_FORMAT, Locale.getDefault());
